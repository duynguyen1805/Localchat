...
public class ChatFrame extends JFrame {
	...
	public ChatFrame(String username, DataInputStream dis, DataOutputStream dos) {
		...
		gl_contentPane.setHorizontalGroup(
				gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_contentPane.createSequentialGroup()
								.addComponent(leftPanel, GroupLayout.PREFERRED_SIZE, 124, GroupLayout.PREFERRED_SIZE)
		...
		JLabel headerContent = new JLabel("LOCAL CHAT");
				...
				while (true) {
					...
					if (method.equals("Text")) {
						...
						if (isChattingOnline == false) {
							...
							JOptionPane.showMessageDialog(null, chatting + " hiện đang offline!\nBạn sẽ được chuyển đến cửa sổ trò chuyện mặc định");
						} else {
